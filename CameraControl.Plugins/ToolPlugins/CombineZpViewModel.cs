    ...
    public class CombineZpViewModel : StackViewModel
    {
        ...
        public void CopyFiles(bool preview)
        {
            ...
            try
            {
                ...
                _tempdir = Path.Combine(Settings.ApplicationTempFolder, Path.GetRandomFileName());
        ...
        public void Combine()
        {
            try
            {
                ...
                _resulfile = Path.Combine(Settings.ApplicationTempFolder, Path.GetFileName(_resulfile));
