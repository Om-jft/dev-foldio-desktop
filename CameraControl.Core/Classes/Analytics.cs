...
namespace CameraControl.Core.Classes
{
    public class Analytics
    {
        ...
        {
            param.ApplicationName = ServiceProvider.Branding.ApplicationTitle ?? "OrangeMonkie";
        ...
        public void Start()
        {
            ...
            try
            {
                ...
                _userAgent = string.Format("OrangeMonkie/{0} (Windows NT {1}.{2}) ", FileVersionInfo.GetVersionInfo(assembly.Location).ProductMajorPart + "." +
                ...
                tracker.Parameters.DocumentHostName = "us.orangemonkie.com";
        ...
        public void Stop()
        {
            ...
            try
            {
                ...
                tracker.Parameters.ApplicationName = "OrangeMonkie";
